...
Route::group(['prefix'=>'admin', 'middleware'=>'auth.checkrole:deliveryman', 'as'=>'admin.'],function(){
...
//qnd for configurar o cors usar composer require barryvdh/laravel-cors 0.7.x
